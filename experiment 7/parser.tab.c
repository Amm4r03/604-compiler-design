...
#line 52 "parser.y"
                          {
        (yyval.ast) = create_node(NODE_ASSIGN, NULL, create_node(NODE_ID, (yyvsp[-3].id), NULL, NULL), (yyvsp[-1].ast));
        printf("Parsed AST:\n");
        print_ast((yyval.ast), 0);
    }
...
#line 59 "parser.y"
                      {
        (yyval.ast) = create_node(NODE_EXPR_PLUS, NULL, (yyvsp[-2].ast), create_node(NODE_ID, (yyvsp[0].id), NULL, NULL));
    }
...
#line 62 "parser.y"
         {
        (yyval.ast) = create_node(NODE_ID, (yyvsp[0].id), NULL, NULL);
    }
